...
# -*- coding: utf-8 -*-
#
# attributed-gossip-concept documentation build configuration file, created by
...
project = u'Attributed Gossip Concept'
...
htmlhelp_basename = 'attributed-gossip-conceptdoc'
...
latex_documents = [
    (master_doc, 'attributed-gossip-concept.tex',
     u'Attributed Gossip Concept Documentation',
...
man_pages = [
    (master_doc, 'attributed-gossip-concept',
     u'Attributed Gossip Concept Documentation',
     [author], 1)
]
